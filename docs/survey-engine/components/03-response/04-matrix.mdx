...
Each *row* can have several properties:
 ...
 - `label` : a [Translatable](../../../general/concepts#translatable) row label 
...
- `label`: [Translatable](/general/concepts#translatable) column label
...
### Dropdown options
 ...
 - `unselectedLabeL`: [Translatable](/general/concepts#translatable) text to be shown when no option is selected
